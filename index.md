...
The research also shows that Artists score higher in **emotionality and agreeableness** at the same time entrepreneurs score higher in **self-efficacy and extraversion**. Our analysis agrees with the research in **emotionality** value. However, the personality values are same for both entrepreneurs and artist for the other three personality traits. To check the significance of these values, we did hypothesis testing on them. T test on theses values show that the difference is not significant. Which means that there is no significant difference in personality of artists and entrepreneurs.
...
We can see that while West is pretty stable, Africa, Europe and Asia seem to be in constant change of personalities.
...
<span id="repo">For more information refer to the analysis [repo](https://github.com/epfl-ada/ada-2021-project-madry)</span>

<span id="footnote" class="center">Brought to you by <span id="names">Mete Ismayil, Yiren Cao, Andrija Kolic and Rohith Jayakumara Sarma</span></span>
